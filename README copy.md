...
Módulo reutilizable de Terraform para provisionar buckets S3 en AWS con controles de seguridad habilitados por defecto.
***
...
| Variable | Tipo | Requerido | Por defecto | Descripción |
|----------|------|-----------|-------------|-------------|
